...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const mobileLinks = document.querySelectorAll('.sdi-mobile-nav-link, .sdi-mobile-sublink');
  ...
  const updateActiveLink = (links) => {
    links.forEach(link => {
      ...
      let isMatch = false;
      if (linkPath.includes('giai-phap-ai-server-local-llm') || linkPath.includes('nganh-phuc-vu')) {
        if (currentPath.includes('giai-phap-ai-server-local-llm') || currentPath.includes('combo-tron-bo') || currentPath.includes('nganh-phuc-vu')) {
          isMatch = true;
        }
      } else if (linkPath.includes('combo-tron-bo')) {
        if (currentPath.includes('combo-tron-bo')) {
          isMatch = true;
        }
      } else if (linkPath.includes('may-don-le')) {
        if (currentPath.includes('may-don-le') || currentPath.includes('chi-tiet-may-don') || currentPath.includes('chi-tiet-linh-kien')) {
          isMatch = true;
        }
      } else if (linkPath.includes('chi-tiet-may-don')) {
        if (currentPath.includes('chi-tiet-may-don')) {
          isMatch = true;
        }
      } else if (linkPath.includes('chi-tiet-linh-kien')) {
        if (currentPath.includes('chi-tiet-linh-kien')) {
          isMatch = true;
        }
      } else if (linkPath.includes('dich-vu-bao-tri')) {
        if (currentPath.includes('dich-vu-bao-tri')) {
          isMatch = true;
        }
      } else if (linkPath.includes('ve-navatek')) {
        if (currentPath.includes('ve-navatek')) {
          isMatch = true;
        }
        ...
        if (currentPath.includes('bai-viet-chi-tiet')) {
          isMatch = true;
        }
      } else if (linkPath.includes('du-an')) {
        if (currentPath.includes('du-an')) {
          isMatch = true;
        }
      }
